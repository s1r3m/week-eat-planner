...
export { weekService } from './api/week.service';
export { default as WeekDetails } from './components/WeekDetails.vue';
export { default as WeekAddCard } from './components/WeekAddCard.vue';
...
export { default as WeeksGrid } from './components/WeeksGrid.vue';
export { default as WeekDeleteDialog } from './components/WeekDeleteDialog.vue';
