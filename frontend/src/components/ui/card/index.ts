...
export const cardVariants = cva('', {
  variants: {
    variant: {
      ...
      week: 'group relative min-h-64 overflow-hidden border-0 rounded-xl transition-all duration-300 hover:shadow-lg hover:scale-[1.02]',
      empty:
        'min-h-64 border-4 border-dashed rounded-xl border-primary rounded-xl flex items-center justify-center cursor-pointer hover:bg-accent/50 transition',
    },
  },
  defaultVariants: {
    variant: 'default',
