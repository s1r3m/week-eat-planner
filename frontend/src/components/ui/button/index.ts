...
export const buttonVariants = cva(
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full text-label-lg font-medium transition-all duration-medium2 ease-emphasized disabled:pointer-events-none disabled:opacity-38 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4.5 shrink-0 [&_svg]:shrink-0 outline-hidden focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 aria-invalid:border-error hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
