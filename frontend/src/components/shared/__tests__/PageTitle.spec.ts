...
describe('PageTitle', () => {
  it('renders both header and description when provided', () => {
    const wrapper = mount(PageTitle, {
      props: { header: 'Test Header', description: 'This is a test description.' },
    });
  ...
  it('omits the description element when description is not provided', () => {
    const wrapper = mount(PageTitle, {
  ...
  it('renders a loading spinner when header is not provided', () => {
    const wrapper = mount(PageTitle);
